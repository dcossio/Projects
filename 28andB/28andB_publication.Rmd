...
# Read in main df
subinfo_DF <- read_csv('/Users/danielacossio/Documents/Chrastil_Lab/Projects/28andB/OpenNeuro/Updated_Trimester.csv')
...
# <span style="color: pink;"> Automatic fiber tracking  </span>  {.tabset .tabset-dropdown}
...
QA_ROI_master_DF <- read.csv("/Users/danielacossio/Documents/Chrastil_Lab/Projects/28andB/OpenNeuro/gestional_figures_info.csv") %>% filter(!(subjects %in% c("sub-27", "sub-07"))) %>% mutate(trimester=AllScanInfo$trimester)
