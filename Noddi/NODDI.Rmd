...
write.csv(HC50_ICVF_allNODDI,paste0(main_dir,"Data/harvardcort50/Re_Cleaned/HC50_ICVF_NODDI.csv"), row.names = FALSE)
...
HC50_ISOVF_gm <- read_csv(paste0(main_dir,"Data/harvardcort50/Raw/all_ISOVF_gmNODDI.csv"))

HC50_ISOVF_wm <- read_csv(paste0(main_dir,"Data/harvardcort50/Raw/all_ISOVF_wmNODDI.csv"))
...
write.csv(HC50_ISOVF_allNODDI,paste0(main_dir,"Data/harvardcort50/Re_Cleaned/HC50_ISOVF_NODDI.csv"), row.names = FALSE)
