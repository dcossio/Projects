...
ModelROIs_L_ICVF_gm <- read_csv(paste0(main_dir,"Data/modelROIs/Raw/all_L_ICVF_gmNODDI.csv"))
ModelROIs_R_ICVF_gm <- read_csv(paste0(main_dir,"Data/modelROIs/Raw/all_R_ICVF_gmNODDI.csv"))
ModelROIs_R_ICVF_wm <- read_csv(paste0(main_dir,"Data/modelROIs/Raw/all_R_ICVF_wmNODDI.csv"))
ModelROIs_L_ICVF_wm <- read_csv(paste0(main_dir,"Data/modelROIs/Raw/all_L_ICVF_wmNODDI.csv"))
...
num_cols <- ncol(ModelROIs_R_ICVF_wm)
num_rows <- nrow(ModelROIs_L_ICVF_wm)
