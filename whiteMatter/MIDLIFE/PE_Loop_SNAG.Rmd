...
read.delim(paste0(working_dir,'/rad3/PE/QA/allSubs/QA_loopRad3_all_neg.csv'), header=FALSE, sep="\t") %>% VarStats()
```  
...
read.delim(paste0(working_dir,'/rad3/PE/QA/allSubs/QA_loopRad3_all_pos.csv'), header=FALSE, sep="\t") %>% VarStats()
```
...
read.delim(paste0(working_dir,'/rad3/PE/QA/male/QA_loopRad3_male_pos.csv'), header=FALSE, sep="\t") %>% VarStats()
```
