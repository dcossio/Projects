...
```{r QA Raw data box plot}
#GEtting my variables together 
estr_cols <- c("Subjects", as.character(Est_QA_all_pos[,1]))
...
Est_QA_all_pos_values <- Est_QA_all_pos_values[,c(1,19,20,2:18)]


# play with plot 

ggplot(Est_QA_all_pos_values, aes(x=status,y= Corpus_Callosum_Body)) +
  geom_boxplot()
