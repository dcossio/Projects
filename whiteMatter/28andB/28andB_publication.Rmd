...
```{r QA all weeks Figures ,echo=FALSE, results='hide',message=FALSE}
...
```{r QA Gestational ,echo=FALSE, results='hide',message=FALSE}
...
```{r Gestational week QAbox plots Figures}
...
```{r Gestational week QA correlations Figures}
...
```
## <span style="color: pink;"> TRactogrpahy output for figures </span>  {.tabset.tabset-dropdown}

```{r Data Cleaning for output, echo=FALSE}
