...
working_dir <- "/Users/danielacossio/Documents/Chrastil_Lab/Projects/SNAG/Cortical_thickness/ANTS/"
...
```{r, female AE avg 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_ae_avg_degree") %>% filter(sex==0)
...
```{r, female AE Ave 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_ae_avg_degree") %>% filter(sex==0)
...
#### Label (apriori)
```{r, female AE avg label + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_ae_avg_degree") %>% filter(sex==0)
...
```{r, male AE avg 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_ae_avg_degree") %>% filter(sex==1)
...
```{r, male AE Ave 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_ae_avg_degree") %>% filter(sex==1)
...
```{r, male AE avg label + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_ae_avg_degree") %>% filter(sex==1)
...
```{r, all AE rad3 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_ae_rad3_degree")
...
for (ROI in ROIs) {
  pcorlist[[ROI]] <-
    pcor.test(x = df["loop_ae_rad3_degree"], y = df[[ROI]], z = df[, c("age_scan_years", "sex")])
  temp <- cbind(ROI, pcorlist[[ROI]])
  cor_results <- rbind(cor_results, temp)
}
...
```{r, all AE rad3 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_ae_rad3_degree") 
...
```{r, all rad3 label  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_ae_rad3_degree") 
...
```{r, female AE rad3 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_ae_rad3_degree") %>% filter(sex==0)
...
for (ROI in ROIs) {
  pcorlist[[ROI]] <-
    pcor.test(x = df["loop_ae_rad3_degree"], y = df[[ROI]], z = df[, c("age_scan_years")])
  temp <- cbind(ROI, pcorlist[[ROI]])
  cor_results <- rbind(cor_results, temp)
}
...
```{r, female AE rad3 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_ae_rad3_degree") %>% filter(sex==0)
...
```{r, female AE rad3 label + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_ae_rad3_degree") %>% filter(sex==0)
...
```{r, male AE rad3 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_ae_rad3_degree") %>% filter(sex==1)
...
```{r, male AE rad3 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_ae_rad3_degree") %>% filter(sex==1)
...
```{r, male AE rad3 label + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_ae_rad3_degree") %>% filter(sex==1)
...
```{r, all PE AVG 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_pe_avg_m")
...
for (ROI in ROIs) {
  pcorlist[[ROI]] <-
    pcor.test(x = df["loop_pe_avg_m"], y = df[[ROI]], z = df[, c("age_scan_years", "sex")])
  temp <- cbind(ROI, pcorlist[[ROI]])
  cor_results <- rbind(cor_results, temp)
}
...
```{r, all PE AVG 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_pe_avg_m") 
...
```{r, all PE AVG label  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_pe_avg_m") 
...
```{r, female PE AVG 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_pe_avg_m") %>% filter(sex==0)
...
```{r, female PE AVG 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_pe_avg_m") %>% filter(sex==0)
...
```{r, female PE AVG label + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_pe_avg_m") %>% filter(sex==0)
...
```{r, male PE AVG 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_pe_avg_m") %>% filter(sex==1)
...
```{r, male PE AVG 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}
...
```{r, male PE AVG label + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_pe_avg_m") %>% filter(sex==1)
...
```{r, all PE rad3 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_pe_rad3_m")
...
for (ROI in ROIs) {
  pcorlist[[ROI]] <-
    pcor.test(x = df["loop_pe_rad3_m"], y = df[[ROI]], z = df[, c("age_scan_years", "sex")])
  temp <- cbind(ROI, pcorlist[[ROI]])
  cor_results <- rbind(cor_results, temp)
}
...
```{r, all PE rad3 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_pe_rad3_m") 
...
```{r, all PE rad3 label  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_pe_rad3_m") 
...
```{r, female PE rad3 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_pe_rad3_m") %>% filter(sex==0)
...
for (ROI in ROIs) {
  pcorlist[[ROI]] <-
    pcor.test(x = df["loop_pe_rad3_m"], y = df[[ROI]], z = df[, c("age_scan_years")])
  temp <- cbind(ROI, pcorlist[[ROI]])
  cor_results <- rbind(cor_results, temp)
}
...
```{r, female PE rad3 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_pe_rad3_m") %>% filter(sex==0)
...
```{r, female PE rad3 label + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_pe_rad3_m") %>% filter(sex==0)
...
```{r, male PE rad3 400 parcs + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17, "loop_pe_rad3_m") %>% filter(sex==1)
...
```{r, male PE rad3 17 network  + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_merged, "loop_pe_rad3_m") %>% filter(sex==1)
...
```{r, male PE rad3 label + Partial correlations, echo=FALSE, results='hide',message=FALSE,warning=FALSE}

df <- CleanDF(CT_17net_ROImerged, "loop_pe_rad3_m") %>% filter(sex==1)
