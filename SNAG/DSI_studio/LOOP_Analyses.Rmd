...
```{r,out.width="65%", warning=FALSE, echo=FALSE,message=FALSE,results='hide'}
...
**Radius 3**
Niether sex nor age predict position error in radius 3
```{r}
...
#### Total T1 HP volume {.tabset .tabset-pills}
...
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Right-Hippocampus`,midlife_HP_df_adj$loop_pe_avg_m, method = "spearman")) %>% mutate(analysis = "Avg_PE_RightHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Right-Hippocampus`,midlife_HP_df_adj$loop_pe_rad3_m, method = "spearman")) %>% mutate(analysis = "rad3_PE_RightHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Right-Hippocampus`,midlife_HP_df_adj$loop_ae_avg_degree, method = "spearman")) %>% mutate(analysis = "Avg_AE_RightHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Right-Hippocampus`,midlife_HP_df_adj$loop_ae_rad3_degree, method = "spearman")) %>% mutate(analysis = "rad3_AE_RightHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Right-Hippocampus`,midlife_HP_df_adj$loop_de_avg_degree, method = "spearman")) %>% mutate(analysis = "Avg_DT_RightHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Right-Hippocampus`,midlife_HP_df_adj$loop_de_rad3_degree, method = "spearman")) %>% mutate(analysis = "rad3_DT_RightHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
#### total T2 HP {.tabset .tabset-pills}
...
```{r}
x %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
```
...
```{r}
x %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "50px", height = "100")
```
...
- Degrees Traveled rad3 is significantly associated with t2 total hippocampus R=-0.54, p=0.009
...
The DKT atlas is used with freesurfer 
