...
#### <span style="text-decoration:underline">Using all subjects regardless of exclusion</span>

SO no age effect but there is a sex effect essentially replicating what shuying found in her original analysis. 

**Degrees Traveled**  

Here only sex is significant associated
...
```{r, plot for 2X2 ANOVA sex,age, AE}
...
#### <span style="text-decoration:underline"> Using only those with HP or diffusion scan and excluding subjects</span>


**Degrees Traveled**   

Here only sex is significantly associated
```{r }

DT_aov <- aov(loop_de_avg_degree ~ age_group * sex, data =all_cleaned_loop )

summary(DT_aov)
```


```{r, plot for 2X2 ANOVA sex,age, DT }
ggboxplot(all_cleaned_loop, x = "age_group", y = "loop_de_avg_degree", color = "sex",
          palette = c("#00AFBB", "#E7B800"))
```

```{r, 2X2 ANOVA sex,age, AE }

AE_aov <- aov(loop_ae_avg_degree ~ age_group * sex, data =all_cleaned_loop )
...
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Left-Hippocampus`,midlife_HP_df_adj$loop_pe_avg_m, method = "spearman")) %>% mutate(analysis = "Avg_PE_LeftHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
- 
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Left-Hippocampus`,midlife_HP_df_adj$loop_pe_rad3_m, method = "spearman")) %>% mutate(analysis = "Rad3_PE_LeftHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
**Avg**
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Left-Hippocampus`,midlife_HP_df_adj$loop_ae_avg_degree, method = "spearman")) %>% mutate(analysis = "Avg_AE_LeftHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
**Rad3**
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Left-Hippocampus`,midlife_HP_df_adj$loop_ae_rad3_degree, method = "spearman")) %>% mutate(analysis = "rad3_AE_LeftHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
**Avg**
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Left-Hippocampus`,midlife_HP_df_adj$loop_de_avg_degree, method = "spearman")) %>% mutate(analysis = "Avg_DT_LeftHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
**Rad3**
```{r}
broom::tidy(cor.test(midlife_HP_df_adj$`Left-Hippocampus`,midlife_HP_df_adj$loop_de_rad3_degree, method = "spearman")) %>% mutate(analysis = "rad3_DT_LeftHP") %>% mutate(parameter = "NA", conf.low= "NA", conf.high= "NA") %>% knitr::kable() %>% kable_styling(bootstrap_options =  c("striped", "hover", "condensed")) %>% scroll_box(width = "800px", height = "200")
...
- degrees traveled is  significantly associated with t2 total hippocampus R=-0.67, p=0.00061
