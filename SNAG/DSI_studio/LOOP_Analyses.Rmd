...
### YOung and midlife 
```{r, summary stats for all participants with useable behavior  }
...
```{r, table for all adults with useable behavior}
...
### Young adult behavior summarized 
- Below are the summary stats for young adults with useable behavior 
...
```{r, table for young adults with useable behavior}
...
- Below are the summary stats for midlife adults with useable behavior 
...
```{r, table for mid adults with useable behavior}
