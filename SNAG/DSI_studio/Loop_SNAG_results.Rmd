...
<!-- ```{r,echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/fname/MD_loop_pe_rad3_all_neg.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/PE/rad3pe.all.md.neg.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
<!-- ```{r,echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/fname/MD_loop_pe_rad3_fem_neg.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/PE/rad3pe.fem.md.neg.csv")), "classic", 500, 200)
```
...
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/fname/MD_loop_pe_rad3_male_pos.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
TableOutput(CleanInput(ReadingCSVFunc("/Loop/MD/nofname/PE/rad3pe.male.md.pos.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/PE/rad3pe.pre.md.neg.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/PE/rad3pe.peri.md.neg.csv")), "classic", 500, 200)
```
...
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/PE/rad3pe.post.md.neg.csv")), "classic", 500, 200)
```
...
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/PE/avepe.all.md.neg.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/PE/avgpe.fem.md.neg.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
TableOutput(CleanInput(ReadingCSVFunc("/Loop/MD/nofname/PE/avgpe.male.md.pos.csv")), "classic", 500, 200)
```
...
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/PE/avgpe.pre.md.neg.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
TableOutput(CleanInput(ReadingCSVFunc("/Loop/MD/nofname/PE/avgpe.peri.md.neg.csv")), "classic", 500, 200)
```
...
TableOutput(CleanInput(ReadingCSVFunc("/Loop/MD/nofname/PE/avgpe.post.md.neg.csv")), "classic", 500, 200)
```
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/DE/rad3de.all.md.pos.csv")), "classic", 500, 200)
```
...
<!-- ```{r,echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/DE/fname/all.loopDE.ave.pos.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/DE/nofname/avgde.all.qa.pos.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
<!-- ```{r,echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/DE/fname/male.loopDE.ave.neg.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/DE/nofname/avgde.male.qa.neg.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
<!-- ```{r,echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/DE/fname/female.loopDE.ave.pos.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/DE/nofname/avgde.fem.qa.pos.csv")), "classic", 500, 200)
```
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/DE/nofname/avgde.pre.qa.pos.csv")), "classic", 500, 200)
```
<br>

<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.006990)</strong> </span>
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/DE/nofname/avgde.pre.qa.neg.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/MD/nofname/DE/avgde.all.md.pos.csv")), "classic", 500, 200)
```
...
<!-- ```{r, echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/fname/all.loopAE.rad3.neg.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/rad3ae.all.qa.neg.csv")), "classic", 500, 200)
```
...
<!-- ```{r, echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/fname/male.loopAE.rad3.neg.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/rad3ae.male.qa.pos.csv")), "classic", 500, 200)
```
<br>

<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.015257)</strong> </span>
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/rad3ae.male.qa.neg.csv")), "classic", 500, 200)
```
<br><br><br><br>
...
<!-- ```{r,echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/fname/female.loopAE.rad3.pos.csv")), "classic", 500, 200) -->
<!-- ``` -->

<!-- <span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.006016)</strong> </span> -->
<!-- ```{r, echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/fname/female.loopAE.rad3.neg.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/rad3ae.fem.qa.pos.csv")), "classic", 500, 200)
```
<br>

<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.009456)</strong> </span>
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/rad3ae.fem.qa.neg.csv")), "classic", 500, 200)
```
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/rad3ae.pre.qa.pos.csv")), "classic", 500, 200)
```
<br>

<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.027984)</strong> </span>
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/rad3ae.pre.qa.neg.csv")), "classic", 500, 200)
```
...
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/rad3ae.peri.qa.neg.csv")), "classic", 500, 200)
```
...
<!-- ```{r,echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/fname/all.loopAE.ave.pos.csv")), "classic", 500, 200) -->
<!-- ``` -->

<!-- <span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.000355)</strong> </span> -->
<!-- ```{r, echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/fname/all.loopAE.ave.neg.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/avgae.all.qa.pos.csv")), "classic", 500, 200)
```
<br>

<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.033989)</strong> </span>
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/avgae.all.qa.neg.csv")), "classic", 500, 200)
```
...
<!-- ```{r, echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/fname/male.loopAE.ave.neg.csv")), "classic", 500, 200) -->
<!-- ``` -->
<!-- <br><br> -->
...
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/avgae.male.qa.neg.csv")), "classic", 500, 200)
```
...
<!-- ```{r,echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/fname/female.loopAe.ave.pos.csv")), "classic", 500, 200) -->
<!-- ``` -->

<!-- <span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.000126)</strong> </span> -->
<!-- ```{r, echo=FALSE,message=FALSE} -->
<!-- TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/fname/female.loopAe.ave.neg.csv")), "classic", 500, 200) -->
<!-- ``` -->
...
```{r,echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/avgae.fem.qa.pos.csv")), "classic", 500, 200)
```

<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.000339)</strong> </span>
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/avgae.fem.qa.neg.csv")), "classic", 500, 200)
```
...
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/avgae.pre.qa.neg.csv")), "classic", 500, 200)
```
...
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/avgae.peri.qa.neg.csv")), "classic", 500, 200)
```
...
<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.023132)</strong> </span>
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("Loop/QA/AE/nofname/avgae.post.qa.neg.csv")), "classic", 500, 200)
```
...
## Corpus Callosum 
  ...
  Anatomy 
  - tapetum
         The tapetum is another fiber tract arising from the body and splenium of the corpus callosum. The tapetum projects laterally to form the roof and lateral walls of the atrium, temporal and occipital horns, where it is the fiber tract closest to the ependyma of the ventricle.
