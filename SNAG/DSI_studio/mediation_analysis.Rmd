...
- Path to the subject sheet that hasthe list of subjects that have both a DSP score AND a DSI scan.
...
Step 1 of mediation is to complete the first correlation in which X= L_fornix and Y = DSP. WE need to regress our x and y 
...
Step 2 of mediation is to complete the next correlation in which M= hormones and Y = DSP
...
White matter not significant with estradiol 
