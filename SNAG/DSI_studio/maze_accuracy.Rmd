...
We had 82 last time so i excluded 2 more people from this analysis. one from low quality and then one bc of health issues
...
All: **(<span style="color: MediumOrchid;"> + </span>) XXXXX**     
Female: **(<span style="color: MediumOrchid;"> + </span>) XXXXX**  
Male: (<span style="color: LightSeaGreen;"> - </span>) 0.055556 | **(<span style="color: MediumOrchid;"> + </span>) XXXXX**     
Pre : **(<span style="color: LightSeaGreen;"> - </span>) 0.023256** | **(<span style="color: MediumOrchid;"> + </span>) XXXXX**     
Peri: **(<span style="color: LightSeaGreen;"> - </span>) 0.002994** | **(<span style="color: MediumOrchid;"> + </span>) XXXXX**      
Post: **(<span style="color: LightSeaGreen;"> - </span>) 0.003425** | **(<span style="color: MediumOrchid;"> + </span>) XXXXX** 
::: 
  
:::{ .column width="50%"}
  **MD FDRs when controlling for FNAME**  
  All: (<span style="color: MediumOrchid;"> + </span>) XXXXX   
  Female: (<span style="color: LightSeaGreen;"> - </span>) XXXXX     
  Male:  **(<span style="color: MediumOrchid;"> + </span>) XXXXX**    
...
<!-- <span style="color: MediumOrchid;font-size: 18px;background-color: Snow"> <strong>Positive (FDR = XXXX)</strong> </span> -->
<!-- # ```{r,echo=FALSE,message=FALSE} -->
...
<!-- <span style="color: MediumOrchid;font-size: 18px;background-color: Snow"> <strong>Positively FDR= XXXXX</strong> </span> -->
<!-- # ```{r,echo=FALSE,message=FALSE} -->
<!-- # TableOutput(CleanInput(ReadingCSVFunc(""))) -->
<!-- #  -->
<!-- # ``` -->
...
<span> Increased QA associaated with **Decreased ACC** FDR= 0.000774</strong> </span>
```{r,echo=FALSE,message=FALSE}
