...
```{r,echo=FALSE,message=FALSE}
rad3PE_neg_MD_all1 <- CleanInput(ReadingCSVFunc("Loop/MD/Loop/nofname/MD_loopRad3_all_neg.csv"))
...
```{r,echo=FALSE,message=FALSE}
rad3PE_neg_MD_fem <- CleanInput(ReadingCSVFunc("Loop/MD/Loop/fname/MD_loop_pe_rad3_fem_neg.csv"))
...
```{r,echo=FALSE,message=FALSE}
rad3PE_neg_MD_fem1 <- CleanInput(ReadingCSVFunc("Loop/MD/Loop/nofname/MD_loopRad3_female_neg.csv"))
...
```{r,echo=FALSE,message=FALSE}
rad3PE_pos_MD_male <- CleanInput(ReadingCSVFunc("Loop/MD/Loop/fname/MD_loop_pe_rad3_male_pos.csv"))
...
```{r,echo=FALSE,message=FALSE}
rad3PE_pos_MD_male1 <- CleanInput(ReadingCSVFunc("/Loop/MD/Loop/nofname/MD_loopRad3_male_pos.csv"))
...
```{r,echo=FALSE,message=FALSE}
rad3DE_pos_MD_all <- CleanInput(ReadingCSVFunc("/Loop/MD/Loop/fname/MD_loop_DE_rad3_all_pos.csv"))
...
```{r,echo=FALSE,message=FALSE}
rad3DE_pos_MD_all1 <- CleanInput(ReadingCSVFunc("Loop/MD/Loop/nofname/MD_loopRad3_all_neg.csv"))
