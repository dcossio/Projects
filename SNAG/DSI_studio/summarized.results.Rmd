...
TableOutput(females_QA, "classic", 500, 200)
```
...
```{r, echo=FALSE,message=FALSE}
all_MD_maze <- CleanInput(ReadingCSVFunc("maze_acc/MD/noFNAME/MD_all_pos.csv"))

TableOutput(all_MD_maze, "classic", 500, 200," Table 1.Tracts with MD positively associated with maze accuracy")
```
<br><br><br><br>
...
```{r, echo=FALSE,message=FALSE}
fem_pos_MD_maze <- CleanInput(ReadingCSVFunc("maze_acc/MD/noFNAME/MD_female_pos.csv"))

TableOutput(fem_pos_MD_maze, "classic", 500, 200," Table 1.Tracts with MD positively associated with maze accuracy")
```
...
```{r, echo=FALSE,message=FALSE}
fem_neg_MD_maze <- CleanInput(ReadingCSVFunc("maze_acc/MD/noFNAME/MD_female_neg.csv"))

TableOutput(fem_neg_MD_maze, "classic", 500, 200," Table 1.Tracts with MD negatively associated with maze accuracy")
```
