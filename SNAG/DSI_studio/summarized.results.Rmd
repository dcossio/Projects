...
figDF %>% filter(REPO != 0) %>%  ggplot(aes(y=maze_accuracy_pct,x=Corticospinal_Tract_L,color=factor(REPO),1))+
  ...
  ylim(min(figDF$maze_accuracy_pct), max(figDF$maze_accuracy_pct)) +
  annotate("text", label = "FDR< 0.01", x = 0.25 , y = 0.9, color="#de5285", size=4) +
     annotate("text", label = "FDR<0.001", x = 0.25 , y = 0.8, color="#00cdff", size=4)  +
     annotate("text", label = "FDR<0.01", x = 0.25 , y = 0.7, color="#f4a2d0", size=4)  
dev.off()
...
figDF %>% filter(REPO != 0) %>% ggplot(aes(y=maze_accuracy_pct,x=Cerebellum_L,color=factor(REPO)))+geom_point() +
  ...
  theme(
    ...
    legend.title=element_blank())+
  ylim(min(figDF$maze_accuracy_pct), max(figDF$maze_accuracy_pct)) +
  annotate("text", label = "FDR< 0.01", x = 0.17 , y = 0.9, color="#de5285", size=4) +
     annotate("text", label = "FDR=0.05", x = 0.17 , y = 0.8, color="#00cdff", size=4)  +
     annotate("text", label = "FDR<0.01", x = 0.17 , y = 0.7, color="#f4a2d0", size=4)  
dev.off()
