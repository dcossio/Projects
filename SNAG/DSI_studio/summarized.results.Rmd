...
<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"><strong>Negative (FDR = )</strong> </span>
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("maze_acc/MD/FNAME/maze.MD.female.neg")), "classic", 500, 200)
```


<p style="text-align:center ; font-size: 24px" > <strong>Previous run</strong> </p>

<span style="color: MediumOrchid;font-size: 18px;background-color: Snow"> <strong>Positive (FDR = 0.071429)</strong> </span>
<br>

```{r, echo=FALSE,message=FALSE}
TableOutput( CleanInput(ReadingCSVFunc("maze_acc/MD/noFNAME/MD_female_pos.csv")), "classic", 500, 200)
```

<br>

<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.061328)</strong> </span>
<br>

```{r, echo=FALSE,message=FALSE}
TableOutput( CleanInput(ReadingCSVFunc("maze_acc/MD/noFNAME/MD_female_neg.csv")), "classic", 500, 200)
```
...
```{r, echo=FALSE,message=FALSE}
TableOutput(CleanInput(ReadingCSVFunc("maze_acc/MD/noFNAME/maze.MD.male.pos.csv")), "classic", 500, 200)
```
...
<span style="color: MediumOrchid;font-size: 18px;background-color: Snow"> <strong>Positive (FDR = 0.012068)</strong> </span>
```{r, echo=FALSE,message=FALSE}
male_pos_MD_maze <- CleanInput(ReadingCSVFunc("maze_acc/MD/noFNAME/MD_male_pos.csv"))

TableOutput(male_pos_MD_maze, "classic", 500, 200," Table 1.Tracts with MD positively associated with maze accuracy")
```

<br>

<span style="color: LightSeaGreen;font-size: 18px;background-color: Snow"> <strong>Negative  (FDR = 0.075269)</strong> </span>
```{r, echo=FALSE,message=FALSE}
